    ...
    <div class="row">
        <div class="col-md-5 col-lg-4 mb-3">
            ...
            <div class="bg-white h-100">
                <div id="carouselExampleFade" class="carousel slide carousel-fade product-gallery">
                    <div class="carousel-inner">
                        ...
                        <?php foreach ($product_img_ids as $product_img_id): ?>
                            <div class="carousel-item">
                                <img data-fancybox="gallery" src="<?php echo wp_get_attachment_url($product_img_id); ?>" class="d-block w-100" alt="<?php echo $product->get_name; ?>">
                        </div>
                        <?php endforeach;?>
                        <?php endif;?>
